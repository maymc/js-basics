...
var favFood = "Japanese";
console.log(favFood);

var favDrink = "juice";
console.log(favDrink);

var favSong = "Anything 90's";
console.log(favSong);
...
var plateLunch = ["poke", "long rice", "loco moco", "katsu", "kalua pork"];
console.log(plateLunch);

var donutBox = ["chocolate", "strawberry", "plain", "sugar", "sprinkles"];
console.log(donutBox);

var westCoast = ["hawaii", "cali", "washington", 
'oregon', "alaska"];
console.log(westCoast);

var lotteryResult = [3, 5, 13, 12, 10];
console.log(lotteryResult);

var hamajang = [3, true, "string", ["food", "toys"], undefined];
console.log(hamajang);

var dynamicDuos = [["red", "green"],[5, 15], [true, false]];
...
console.log(partyList.length); //6
...
var sameNum = "5" === 5;
console.log(sameNum); //no, type is diff

var sameNumba = "5" == 5;
console.log(sameNumba); //true
...
function bakePie(ingredient){
	console.log("Today's special is " + ingredient + " pie.");
}
...
var foodResult = makeFood("pepperoni", "cheese", "pizza");
